SELECT * FROM harika.online_education_dataset;
create database online_education_dataset;
use online_education_dataset;
-- Total Number of Students
SELECT COUNT(DISTINCT id_student) AS total_students FROM harika.online_education_dataset;
